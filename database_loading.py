...
skill_nlp = spacy.load("./resumeModels/ner_model_skills")
...
with open("resume_579.txt", encoding="utf-8") as file:
...
cur.execute('INSERT INTO "public"."Resume" (resume_id, resume_text) VALUES (10579, %s) RETURNING resume_id', (resume_text,))
